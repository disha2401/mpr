...
print("d1 l1")
model = LogisticRegression(penalty='l1', C=1.0, class_weight=None, solver='liblinear')
...
#             print("d2 l2")
#             model = LogisticRegression(penalty='l2', C=7.742637, class_weight=None, solver='liblinear')
#     elif SELECTED_MODEL == 'RandomForest':
#         print("Training random forest classifier...")
#         from sklearn.ensemble import RandomForestClassifier
#
#         if SELECTED_DATASET == 'dataset1':
#             print("d1 randomforest")
#
#             model = RandomForestClassifier(n_estimators=500,
#                                            max_features='sqrt', max_depth=3,
#                                            random_state=42)
#         elif SELECTED_DATASET == 'dataset2':
#             print("d2 randomforest")
#
